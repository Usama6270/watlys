          ...
          >
            ...
            <div className="pt-4 border-t border-zinc-200/30 dark:border-zinc-800/30 font-sans">
              <Link
                ...
                className="inline-flex items-center space-x-2 text-[9px] font-bold uppercase tracking-widest text-[#111111] dark:text-[#FAFAFA] hover:text-[#0064D0] transition-colors"
              >
