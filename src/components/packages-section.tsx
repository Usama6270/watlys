  ...
  return (
    <section id="packages" className="py-24 px-6 max-w-7xl mx-auto w-full border-t border-zinc-200/40 dark:border-zinc-800/40 bg-white dark:bg-[#0A0A0A] font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
        ...
        {/* 4. CUSTOM PACKAGE */}
        <div className="flex flex-col justify-between bg-zinc-50/80 dark:bg-[#0E0E0E] border border-zinc-200/80 dark:border-zinc-800/80 p-8 rounded-2xl transition-all duration-400 hover:border-[#0064D0] shadow-sm group">
          <div className="space-y-6">
            <div className="flex justify-between items-center">
